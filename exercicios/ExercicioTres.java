...
class ExercicioTres {
    public static void main(String[] args) {
        ...
        System.out.println("-----");//b.Ordem Natural, por Nome;
            Set<LinguagemFavorita> minhasLinguagensB = new TreeSet<>(new ComparaNome());
            minhasLinguagensB.addAll(minhasLinguagens);
            for (LinguagemFavorita linguagemB : minhasLinguagensB) {
                System.out.println(linguagemB);
            }
        System.out.println("-----");//c.Ordem Natural, por IDE;
            Set<LinguagemFavorita> minhasLinguagensC = new TreeSet<>(new ComparaIde());
            minhasLinguagensC.addAll(minhasLinguagens);
            for (LinguagemFavorita linguagemC : minhasLinguagensC) {
                System.out.println(linguagemC);
            }
        System.out.println("-----");//d.Ordem Natural, por Ano de Criacao e Nome;
            Set<LinguagemFavorita> minhasLinguagensD = new TreeSet<>(new ComparaCriacaoNome());
            minhasLinguagensD.addAll(minhasLinguagens);
            for (LinguagemFavorita linguagemD : minhasLinguagensD) {
                System.out.println(linguagemD);
            }
        System.out.println("-----");//e.Ordem Natural, por Nome, Ano de Criacao e IDE;
            Set<LinguagemFavorita> minhasLinguagensE = new TreeSet<>(new ComparaNomeCriacaoIde());
